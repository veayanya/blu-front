  ...
  <aside class="sidebar">
    ...
    <div class="sidebar-footer">
      ...
      <div class="api-status-row">
        ...
        <p v-if="!apiStatus.geminiKeySet" class="api-not-config-msg">
        ...
        <div class="user-info">
          ...
          <span class="user-role">
            <span :class="['role-tag', props.currentUser?.role === 'admin' ? 'role-tag-admin' : (props.currentUser?.role === 'moderator' ? 'role-tag-moderator' : 'role-tag-user')]">
              {{ props.currentUser?.role === 'admin' ? '🛡️ Admin' : (props.currentUser?.role === 'moderator' ? '⭐ Moderator' : '👤 User') }}
            </span>
          </span>
        </div>
