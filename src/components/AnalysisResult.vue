    ...
    <div v-if="showReuploadModal" style="position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:center;justify-content:center;">
      <div style="background:var(--bg-card,#fff);border-radius:14px;padding:28px 24px;max-width:540px;width:90%;box-shadow:0 8px 40px rgba(0,0,0,0.18);">
        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 6px;">
          <div style="width: 36px; height: 36px; border-radius: 50%; background: rgba(14, 107, 94, 0.12); color: var(--primary-color, #0e6b5e); display: flex; align-items: center; justify-content: center;">
        ...
        >
          ...
          <div v-if="!selectedReuploadFile" style="display: flex; flex-direction: column; align-items: center; gap: 6px;">
            <i data-lucide="upload-cloud" style="width: 36px; height: 36px; color: var(--primary-color, #0e6b5e);"></i>
          ...
          <div v-else style="display: flex; align-items: center; justify-content: space-between; padding: 6px 10px; background: #fff; border: 1px solid #e2e8f0; border-radius: 6px;" @click.stop>
            <div style="display: flex; align-items: center; gap: 8px; text-align: left;">
              <i data-lucide="file-text" style="width: 20px; height: 20px; color: var(--primary-color, #0e6b5e);"></i>
              <div>
        ...
        <div v-else style="background: #fff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 14px; margin: 10px 0;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
            ...
            <span style="font-size: 0.82rem; font-weight: 800; color: var(--primary-color, #0e6b5e);">{{ reuploadProgress }}%</span>
          </div>
          <div style="height: 6px; border-radius: 3px; background: #f1f5f9; overflow: hidden;">
            <div :style="{ width: reuploadProgress + '%' }" style="height: 100%; background: var(--primary-color, #0e6b5e); transition: width 0.3s ease;"></div>
          </div>
        </div>
        ...
        <div style="display: flex; justify-content: flex-end; gap: 10px; margin-top: 18px;">
          ...
          <button :disabled="!selectedReuploadFile || isReanalyzing" @click="executeReanalysis" style="display: flex; align-items: center; gap: 6px; padding: 7px 16px; border-radius: 7px; background: var(--primary-color, #0e6b5e); color: #fff; border: none; cursor: pointer; font-size: 0.85rem; font-weight: 600;">
    ...
    <div class="sroi-body">
      ...
      <div class="rka-section">
        ...
        <div class="sroi-factors-card">
          <div class="sroi-factors-title">⚖️ Faktor Penyesuaian Dampak Sosial</div>
